...
function FloatingWA() {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      href="https://wa.me/919787317484?text=Hi%20OrbX%20Team,%20I%20would%20like%20to%20know%20more%20about%20OrbX%20for%20my%20business."
      target="_blank"
      rel="noreferrer"
      aria-label="Chat on WhatsApp"
      className="fixed bottom-6 right-6 z-[200] w-14 h-14 bg-[#25D366] hover:bg-[#20bd5a] rounded-full flex items-center justify-center shadow-2xl shadow-[#25D366]/40 transition-colors group"
    >
