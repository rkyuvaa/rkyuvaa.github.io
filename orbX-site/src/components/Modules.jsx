        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
          {modules.map((m,i)=>(
            <motion.div key={i} variants={scaleIn} initial="hidden" animate={inView?'visible':'hidden'}
              ...
              <div className="w-11 h-11 bg-[#00a86b]/12 rounded-xl flex items-center justify-center mb-4 group-hover:bg-[#023020] transition-colors duration-300">
                <m.icon size={20} className="text-[#00a86b] group-hover:text-white transition-colors duration-300"/>
              </div>
