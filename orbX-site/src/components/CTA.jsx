  ...
  return (
    <section className="py-24 dark-bg relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute bottom-0 right-1/4 w-[350px] h-[350px] rounded-full bg-[#00a86b]/5 blur-[70px]"/>
      </div>
      <div className="max-w-[780px] mx-auto px-6 text-center relative z-10">
        ...
        <motion.div
          ...
          <a href="#contact"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-[14px] bg-white text-[#023020] font-semibold text-base hover:bg-[#00a86b] hover:text-white transition-all shadow-2xl hover:-translate-y-0.5">
